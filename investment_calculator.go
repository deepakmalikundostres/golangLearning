...
func investmentCalculatorV1() {
	...
	// expectedReturnRate,testingNo := 5.5,1
	// investmentAmount, year := 1000.0,10.0
	// expectedReturnRate,testingNo := 5.5,1.7
	

    // don't need explict type then no need to use var
